          ...
          <div className="rounded-3xl aurum-glass ring-1 ring-white/10">
            <div className="p-6 text-sm text-white/70">
              ...
              <div className="mt-2 leading-relaxed">
                Gold prices can fluctuate due to macroeconomic factors, currency movements, and market sentiment. Your
              ...
              <div className="mt-2 leading-relaxed">
                Manual payment verification, compliance review, and administrative processes can introduce delays.
                Ensure you provide accurate payment references and proof uploads.
              </div>
